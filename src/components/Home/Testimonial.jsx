...
import avatar from '../../assets/images/ProfileIcon.svg'
...
const Testimonial = () => {
  ...
  return (
    ...
    <div className='w-3/4 m-auto'>
        ...
        <Slider {...settings}>
            {data.map((d)=>(
                <div className='py-[25px] px-[5px] border border-gray-400 rounded-lg shadow-lg shadow-[#ECDCFF] bg-gradient-to-b from-[#ECDCFF] to-white'>
